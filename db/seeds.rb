...
Crop.create(name: "Tomato", variant: "Pink Ponderosa", garden_id: 1, plant_date: "2013-5-07")
...
Crop.create(name: "Kale", variant: "Dinosaur", garden_id: 1, plant_date: "2013-3-15", harvest_date: "2013-5-30")
Crop.create(name: "Kale", variant: "Dinosaur", garden_id: 2)
Crop.create(name: "Beets", variant: "Yellow", garden_id: 1)
Crop.create(name: "Swiss Chard", variant: "My First Try", garden_id: 1, plant_date: "2013-2-28", harvest_date: "2013-4-30")
